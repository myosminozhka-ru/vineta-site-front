  ...
  <div class="catalog__header">
    ...
    <div class="catalog__header_right hide_on_mobile">
      ...
      <template v-if="getDownloads['katalog-produktsii']">
        <a v-if="'PROPERIES' in getDownloads['katalog-produktsii']" :href="$vareibles.remote + getDownloads['katalog-produktsii'].PROPERIES[0].VALUE.SRC" target="_blank" download="catalogue_Vineta" class="catalog__header_link">
          <div class="icon">
