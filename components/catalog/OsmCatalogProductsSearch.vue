<template>
    <div class="products">
        <div class="products__items products__items--search">
            <nuxt-link class="products__item" v-for="product in products" :key="product.index" :to="localePath({name: 'catalog-catalogId-productId', params: {productId: product.CODE}})">
