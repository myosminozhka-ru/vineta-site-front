<template>
  <nav class="header__menu" @mouseleave="closeModals">
    ...
    <ul class="header__ul hide_on_mobile">
      <li
        class="header__li has-child"
        @mouseenter.stop="openModal(123)"
        :data-modal-to-open="123"
      >
        <nuxt-link
          class="header__link"
          :to="localePath({ name: 'catalog' })"
          @click.stop=""
        >
      ...
      <li
        ...
        :key="link.index"
        class="header__li"
        @mouseenter.stop="openModal(key)"
        :data-modal-to-open="key"
        :class="{ 'has-child': link.childs }"
      >
        <nuxt-link
          class="header__link"
          :to="localePath({ name: link.url })"
          @click.stop=""
        >
          <span>{{ link.text }}</span>
      ...
      >
        ...
        >
          ...
          <div class="menu__modal_list">
            ...
            <a
              target="_blank"
              href="~/assets/files/vineta_book_TP_rus_001.pdf"
              class="menu__modal_file"
              download=""
            >
              <div class="icon">
            ...
            <a
              target="_blank"
              href="~/assets/files/Vineta_book_VO_rus_ver012.pdf"
              class="menu__modal_file"
              download=""
            >
              <div class="icon">
            ...
            <a
              target="_blank"
              href="~/assets/files/vineta_book_TO_002.pdf"
              class="menu__modal_file"
              download=""
            >
              <div class="icon">
            ...
            <a
              target="_blank"
              href="~/assets/files/Vineta_book_VGO_ru_002.pdf"
              class="menu__modal_file"
              download=""
            >
              <div class="icon">
    ...
    <div
      @click="openSearch"
      class="header__button header__button--search hide_off_mobile"
    >
      <object :data="require(`~/assets/img/search.svg`)" width="100%" />
    </div>
    <nuxt-link
      class="header__button header__button--favorites hide_off_mobile"
  ...
  methods: {
    ...
    openModal(id) {
      ...
      document
        ...
        .classList.add('isOpened')
      document
        .querySelector(`[data-modal-to-open="${id}"]`)
