<template>
  <div class="header__info">
    <div
      class="header__button header__button--search hide_on_mobile"
      @click="openSearch"
    >
      <svg
        width="100%"
    ...
    <div class="header__langs hide_on_mobile" v-show="false">
      <nuxt-link
    ...
    <a
      class="header__button header__button--phone hide_off_mobile"
      href="tel:+78124935048"
    >
