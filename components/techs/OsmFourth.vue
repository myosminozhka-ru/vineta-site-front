                ...
                <div class="section__bottom--tech">
                    ...
                    <div class="section__right--tech" @mousewheel.stop>
                        ...
                        <div class="texts">
                            ...
                            <ul class="list">
                                <li>Токарная обработка деталей токарно-винторезными станками;</li>
                                <li>Фрезерная обработка на вертикально-фрезерных обрабатывающих центрах;</li>
                                <li>Станки сверлильной группы (вертикально-сверлильные, радиально-сверлильные);</li>
