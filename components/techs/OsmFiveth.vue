<template>
    <section class="section section__item">
        <div class="header_padding">
            <div class="section__item__in">
                <div class="section__top--tech">
                    <osm-breadcrumbs />
                </div>
                ...
                <div class="section__bottom--tech">
                    ...
                    <div class="section__right--tech" @mousewheel.stop>
                        ...
                        <div class="texts">
                            ...
                            <p class="text">
                                На предприятии осуществляется сварка изделий из
                                углеродистых и высоколегированных (коррозионностойких) сталей,
                                а также алюминиевых сплавов, сплавов на основе меди и титановых сплавов.
                                Сварка производится отечественными сварочными материалами.
                            </p>
                            <div class="bg_text">
                                Сварка на предприятии выполняется высококвалифицированными сварщиками,
                                обученными и аттестованными на выполнение ручной, полуавтоматической и
                                автоматической аргонодуговой сварки, имеющими свидетельства о допуске
                                к сварке изделий поднадзорных ВП МО РФ, РМРС, РРР, а также оборудования
