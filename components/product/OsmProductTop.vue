  ...
  <div class="product__header_wrap">
    <div class="product__header">
      <div class="product__header_row">
        <h1 class="product__header_left" v-if="'NAME' in data">
          {{ data.NAME }}
        </h1>
      </div>
    ...
    <div class="product__header_buttons hide_on_mobile">
      <div
        class="product__header_mods"
        v-if="offersCount.length"
        @click="scrollToModifications"
      >
        Модификаций ({{ offersCount.length }})
      </div>
