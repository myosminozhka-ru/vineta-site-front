<template>
  <div class="wrapper">
    ...
    <div class="full-page-indicators" :class="{ white: +activeIndex === 5 }">
      <div
        class="indicator"
        v-for="(indicator, key) in sections"
        :key="indicator.index"
