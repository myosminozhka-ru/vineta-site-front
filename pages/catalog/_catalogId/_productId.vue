      ...
      <div class="productPage__info">
        ...
        <div class="productPage__texts" v-if="'PROPERIES' in product[0]">
          <div
            ...
            v-for="item in product[0].PROPERIES"
            :key="item.index"
          >
        ...
        <div class="productPage__buttons">
          ...
          <div
            @click="addFavorites(product[0].ID)"
        ...
        <div class="productPage__mods--tabs hide_on_tablet">
          <div class="titles">
            <div
              ...
              v-if="'DETAIL_TEXT' in product[0] && product[0].DETAIL_TEXT"
            >
              <osm-button
                class="productPage__mods--opener"
                :large="true"
                :class="{ isActive: tabs.selected === 1 }"
                :outlined="true"
              >
                Описание</osm-button
              >
            ...
            >
              <osm-button
                class="productPage__mods--opener"
                :large="true"
                :class="{ isActive: tabs.selected === 3 }"
                :outlined="true"
              >
          ...
          <div class="tabs">
            ...
            >
              ...
              <div class="productPage__buttons">
                ...
                >
                  <osm-button
                    class="productPage__buttons--fav"
                    :outlined="true"
                  >
                    <div class="icon">
                      <svg
              ...
              <div class="value">
                ...
                <div class="productPage__mods--chars">
                  <div
                    ...
                    v-for="prop in product[0].PROPERIES"
                    :key="prop.index"
                  >
          ...
          <div class="tabs">
            ...
            <div v-if="tabs.selected === 3">
              ...
              >
                ...
                <div
                  class="productPage__buttons"
                  @click.stop
                  v-if="tabs.openedMod === index"
                >
                  <div @click="openBuy">
                    <osm-button class="productPage__buttons--buy">{{
                      $t('buttons.checkout')
      ...
      <div class="productPage__analogs">
        <div class="productPage__analogs_top">
          ...
          <div class="productPage__analogs_top_arrows hide_on_desktop">
            <button
              class="productPage__arrow productPage__arrow--left"
              @click="prevSlide"
              data-glide-dir="<"
            >
              <svg
            ...
            <button
              class="productPage__arrow productPage__arrow--right"
              @click="nextSlide"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              >
                ...
                <div class="products__item_image">
                  <div class="image_container">
                    <img
                      :src="$vareibles.remote + prod.PREVIEW_PICTURE"
                      alt=""
                    />
                  </div>
                </div>
                <div class="products__item_data">
                  ...
                  <div class="products__item_properties">
                    <div
                      ...
                      v-for="property in prod.PROPERIES.slice(0, 3)"
                      :key="property.index"
                    >
...
export default {
  ...
  data: () => ({
    ...
    offersCount: [],
    printUpText:
      '187026, Санкт-Петербург, Ленинградская обл., Тосненский район, <br>г. Никольское, Ульяновское шоссе, 5Г <br>тел./факс: +7(812) 493-50-48info@vineta.ru',
  }),
  head() {
    return {
      title:
        this.product && 'SEO' in this.product[0]
      ...
      meta: [
        ...
        },
        {
          ...
          name: 'twitter:imag',
          content:
            this.product && 'PREVIEW_PICTURE' in this.product[0]
