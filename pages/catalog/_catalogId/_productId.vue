      ...
      <div class="productPage__info">
        ...
        <div class="productPage__buttons">
          ...
          <template v-if="getDownloads['katalog-produktsii']">
            <a v-if="'PROPERIES' in getDownloads['katalog-produktsii']" :href="$vareibles.remote + getDownloads['katalog-produktsii'].PROPERIES[0].VALUE.SRC" target="_blank" class="productPage__link hide_off_mobile">
              <div class="icon">
    ...
    <div class="productPage__container">
      <div id="modifications" class="productPage__mods">
                  ...
                  <osm-button class="productPage__buttons--fav" :outlined="true">
                    <div class="icon">
                      <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M21 2.3335H7C6.07174 2.3335 5.1815 2.70225 4.52513 3.35862C3.86875 4.015 3.5 4.90524 3.5 5.8335V18.6668C3.5 19.5951 3.86875 20.4853 4.52513 21.1417C5.1815 21.7981 6.07174 22.1668 7 22.1668H10.0217L13.1717 25.3285C13.2807 25.4366 13.41 25.5222 13.5521 25.5802C13.6943 25.6383 13.8465 25.6677 14 25.6668C14.2781 25.6669 14.547 25.5676 14.7583 25.3868L18.515 22.1668H21C21.9283 22.1668 22.8185 21.7981 23.4749 21.1417C24.1313 20.4853 24.5 19.5951 24.5 18.6668V5.8335C24.5 4.90524 24.1313 4.015 23.4749 3.35862C22.8185 2.70225 21.9283 2.3335 21 2.3335ZM22.1667 18.6668C22.1667 18.9762 22.0438 19.273 21.825 19.4918C21.6062 19.7106 21.3094 19.8335 21 19.8335H18.0833C17.8053 19.8335 17.5363 19.9328 17.325 20.1135L14.0583 22.9135L11.3283 20.1718C11.2193 20.0637 11.09 19.9782 10.9479 19.9201C10.8057 19.862 10.6535 19.8326 10.5 19.8335H7C6.69058 19.8335 6.39383 19.7106 6.17504 19.4918C5.95625 19.273 5.83333 18.9762 5.83333 18.6668V5.8335C5.83333 5.52408 5.95625 5.22733 6.17504 5.00854C6.39383 4.78975 6.69058 4.66683 7 4.66683H21C21.3094 4.66683 21.6062 4.78975 21.825 5.00854C22.0438 5.22733 22.1667 5.52408 22.1667 5.8335V18.6668Z" fill="#172242" />
                      </svg>
                    </div>
                    <div class="text">{{ $t('buttons.to_favorites') }}</div>
                  </osm-button>
        ...
        <div class="productPage__mods--tabs hide_on_desktop">
          <div class="tabs">
            <div v-if="'DETAIL_TEXT' in product[0] && product[0].DETAIL_TEXT" class="tabs__opener" :class="{ isActive: tabs.selected === 1 }" @click.prevent="tabs.selected = 1">
